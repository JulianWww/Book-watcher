...
def get_fiction_base_url(fiction_id):
    return "https://www.royalroad.com/fiction/"+str(fiction_id)

def get_fiction_chapter_url(chapter_url):
    return "https://www.royalroad.com" + chapter_url
...
def get_fiction_object(fiction_id):
    ...
    url =  get_fiction_base_url(fiction_id) #construct the url
    soup = request_soup(url) #request the soup
